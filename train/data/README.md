...
| `prompts/` | Prompt templates for contract proposal, contract review, and artifact proposal. Rendered prompt records are scratch synthesis requests, not training data. | Phase 1 prompt gate |
